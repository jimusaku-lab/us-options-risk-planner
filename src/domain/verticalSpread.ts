...
export function calculateVerticalSpreadEstimate(simulation: TradeSimulation, asOfDate = formatLocalDate(), priceResolver?: (leg: OptionLeg) => number | undefined): VerticalSpreadEstimate {
