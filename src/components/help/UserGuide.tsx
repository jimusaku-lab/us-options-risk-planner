      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-2">
        ...
        <GuideBlock
          ...
          items={[
            ...
            "DEMOではDEMO / JPYベースの現金残高、買付可能額、必要証拠金、証拠金使用率を入力します。",
        ...
        <GuideBlock
          ...
          items={[
            ...
            "カバードコールでは保有株数と取得単価を入力します。プット売り単体では現物株入力は使わず、権利行使時の買付資金を分母比較や追加買付資金カードで確認します。",
        ...
        <GuideBlock
          ...
          items={[
            "候補リスト機能では、TradingView等で作成した候補JSON/CSVを取り込み、建玉案の入口として使えます。最終的な数値はSaxo画面を見て確認してください。",
